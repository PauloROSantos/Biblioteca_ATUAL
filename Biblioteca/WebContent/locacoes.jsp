...
<div class="corpo">
	<table class="tabela_livros" align="center">
			...
			<% JDBCLocacaoDAO loc = new JDBCLocacaoDAO();
				...
				List<Locacao> locacoes = loc.listar(id);
				...
				<tr class="tabela_livros">
					<td class="tabela_livros"><%= locacao.getNome_livro() %></td>
					<td class="tabela_livros"><%= locacao.getData_emprestimo() %></td>
					<td class="tabela_livros"> Locado </td>
